...
import day02.threadsafe.Reordering.Case2;
import org.openjdk.jcstress.infra.results.II_Result;

public final class Reordering_Case2_jcstress extends Runner<II_Result> {

    volatile WorkerSync workerSync;
    Case2[] gs;
    II_Result[] gr;

    public Reordering_Case2_jcstress(ForkedTestConfig config) {
        super(config);
    }
    ...
    private void run_actor1(Case2[] gs, II_Result[] gr, int start, int end) {
        Case2[] ls = gs;
        II_Result[] lr = gr;
    ...
    private void run_actor2(Case2[] gs, II_Result[] gr, int start, int end) {
        Case2[] ls = gs;
        II_Result[] lr = gr;
        for (int c = start; c < end; c++) {
            Case2 s = ls[c];
