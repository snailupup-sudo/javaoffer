...
import day02.threadsafe.Reordering.Case3;
import org.openjdk.jcstress.infra.results.II_Result;

public final class Reordering_Case3_jcstress extends Runner<II_Result> {

    volatile WorkerSync workerSync;
    Case3[] gs;
    II_Result[] gr;

    public Reordering_Case3_jcstress(ForkedTestConfig config) {
        super(config);
    }
    ...
    private void run_actor1(Case3[] gs, II_Result[] gr, int start, int end) {
        Case3[] ls = gs;
        II_Result[] lr = gr;
    ...
    private void run_actor2(Case3[] gs, II_Result[] gr, int start, int end) {
        Case3[] ls = gs;
        II_Result[] lr = gr;
        for (int c = start; c < end; c++) {
            Case3 s = ls[c];
